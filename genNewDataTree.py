...
with open('sentence-simulator-master/TreeSum.json', 'w', encoding='utf-8') as fwrite:
    with open('TreeSum.json', 'w', encoding='utf-8') as fw:
        ...
        for name in os.listdir('newData/active_packages'):
            with open("newData/active_packages/" + name, "r",encoding='utf-8') as fRead:
                test = json.load(fRead)
                children.append(test['rule']['children'][1])
        entity = package['entity']
        for name in os.listdir('newData/active_entities'):
            with open("newData/active_entities/" + name, "r",encoding='utf-8') as fRead:
                list = []
                while 1:
